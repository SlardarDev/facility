...
func BoolDefault(from interface{}, d bool) bool {
	if v, err := conv.Bool(from); err == nil {
		return v
	}
	return d
}
...
func DurationDefault(from interface{}, d time.Duration) time.Duration {
	if v, err := conv.Duration(from); err == nil {
		return v
	}
	return d
}
...
func TimeDefault(from interface{}, d time.Time) time.Time {
	if v, err := conv.Time(from); err == nil {
		return v
	}
	return d
}
...
func Float32Default(from interface{}, d float32) float32 {
	if v, err := conv.Float32(from); err == nil {
		return v
	}
	return d
}
...
func Float64Default(from interface{}, d float64) float64 {
	if v, err := conv.Float64(from); err == nil {
		return v
	}
	return d
}
...
func IntDefault(from interface{}, d int) int {
	if v, err := conv.Int(from); err == nil {
		return v
	}
	return d
}
...
func Int8Default(from interface{}, d int8) int8 {
	if v, err := conv.Int8(from); err == nil {
		return v
	}
	return d
}
...
func Int16Default(from interface{}, d int16) int16 {
	if v, err := conv.Int16(from); err == nil {
		return v
	}
	return d
}
...
func Int32Default(from interface{}, d int32) int32 {
	if v, err := conv.Int32(from); err == nil {
		return v
	}
	return d
}
...
func Int64Default(from interface{}, d int64) int64 {
	if v, err := conv.Int64(from); err == nil {
		return v
	}
	return d
}
...
func UintDefault(from interface{}, d uint) uint {
	if v, err := conv.Uint(from); err == nil {
		return v
	}
	return d
}
...
func Uint8Default(from interface{}, d uint8) uint8 {
	if v, err := conv.Uint8(from); err == nil {
		return v
	}
	return d
}
...
func Uint16Default(from interface{}, d uint16) uint16 {
	if v, err := conv.Uint16(from); err == nil {
		return v
	}
	return d
}
...
func Uint32Default(from interface{}, d uint32) uint32 {
	if v, err := conv.Uint32(from); err == nil {
		return v
	}
	return d
}
...
func Uint64Default(from interface{}, d uint64) uint64 {
	if v, err := conv.Uint64(from); err == nil {
		return v
	}
	return d
}
